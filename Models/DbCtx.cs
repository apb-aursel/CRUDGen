...
namespace CRUDGen.Models
{
    public partial class DbCtx : DbContext
    {
        ...
        public virtual DbSet<ARQ_EXPEDIENTRELACIONAT> ARQ_EXPEDIENTRELACIONAT { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseOracle("User Id=APBDOTNET;Password=a_zTYk3ANa82yX6x;Data Source=orasuddev.port.apb.es:1521/TEST;");
            }
        }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.HasDefaultSchema("APBDOTNET")
                .UseCollation("USING_NLS_COMP");

            modelBuilder.Entity<ARQ_EXPEDIENT>(entity =>
            {
                entity.HasKey(e => e.ARQ_EXPEDIENT_ID)
                    .HasName("ARQ_EXPEDIENT_PK");

                entity.HasIndex(e => e.NOMINTERN, "ARQ_EXPEDIENT_UK1")
                    .IsUnique();

                entity.Property(e => e.ARQ_EXPEDIENT_ID).HasPrecision(10);

                entity.Property(e => e.ALFRESCOPATH)
                    .HasMaxLength(1000)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd();

                entity.Property(e => e.ARQ_APPFASES_NI)
                    .HasMaxLength(40)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd();
                ...
                entity.Property(e => e.ARQ_EVENT_FK)
                    .HasPrecision(10)
                    .ValueGeneratedOnAdd()
                    .HasDefaultValueSql("0 ");

                entity.Property(e => e.ARQ_EXPEDIENTESTAT_NI)
                    .HasMaxLength(40)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd();

                entity.Property(e => e.ARQ_EXPEDIENTTIPUS_NI)
                    .HasMaxLength(40)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd()
                ...
                entity.Property(e => e.CONCURRENCYGUID)
                    .HasMaxLength(36)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd()
                ...
                entity.Property(e => e.NOMINTERN)
                    .HasMaxLength(40)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd();

                entity.Property(e => e.NOMVISIBLE)
                    .HasMaxLength(255)
                    .IsUnicode(false)
                    .ValueGeneratedOnAdd();
            });

            modelBuilder.Entity<ARQ_EXPEDIENTRELACIONAT>(entity =>
            {
                entity.HasKey(e => new { e.NOMINTERN, e.ARQ_EXPEDIENT_NI })
                    .HasName("ARQ_EXPEDIENTRELACIONAT_PK");
                ...
                entity.HasOne(d => d.ARQ_EXPEDIENT_NINavigation)
                    .WithMany(p => p.ARQ_EXPEDIENTRELACIONATARQ_EXPEDIENT_NINavigation)
                    .HasPrincipalKey(p => p.NOMINTERN)
                    .HasForeignKey(d => d.ARQ_EXPEDIENT_NI)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ARQ_EXPEDIENTRELACIONAT_FK2");

                entity.HasOne(d => d.NOMINTERNNavigation)
                    .WithMany(p => p.ARQ_EXPEDIENTRELACIONATNOMINTERNNavigation)
                    .HasPrincipalKey(p => p.NOMINTERN)
                    .HasForeignKey(d => d.NOMINTERN)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("ARQ_EXPEDIENTRELACIONAT_FK1");
            });
            ...
            modelBuilder.HasSequence("ARQ_BPMPROCES_SEQ").IncrementsBy(21);
            ...
            modelBuilder.HasSequence("PEM_CFG_GRUP_SEQ");

            modelBuilder.HasSequence("PEM_CFG_PARAMETRE_SEQ");

            modelBuilder.HasSequence("PEM_CFG_TAG_SEQ");

            modelBuilder.HasSequence("PEM_GRUP_COMPORTAMENT_SEQ");

            modelBuilder.HasSequence("PEM_MEDI_CONTACTE_SEQ");

            modelBuilder.HasSequence("PEM_MEDI_MATERIAL_SEQ");

            modelBuilder.HasSequence("PEM_NIVELL_EMERGENCIA_SEQ");

            modelBuilder.HasSequence("PEM_SALT_NIVELL_SEQ");

            modelBuilder.HasSequence("PEM_TIPUS_COMPORTAMENT_SEQ");
